...
// Méthode qui affiche les éléments de la file
void AfficherFile(Queue<Livre> file)
{
...
// Méthode qui inverse la file passée en paramètres en utilisant une pile
void InverserFile(Queue<Livre> file)
{
